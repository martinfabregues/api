...
module.exports = function(app)
{
	...
	app.get("/user/update/:id", function(req, res){
		...
		if(!isNaN(id))
		{
			ClienteModel.getUser(id,function(error, data)
			{
	...
	app.get("/clientes/create", function(req, res){
		res.render("new",{ 
	...
	app.get("/getClientes/:id", function(req, res)
	{
		//id del usuario
		var id = req.params.id;
		//solo actualizamos si la id es un número
	...
	app.put("/users", function(req,res)
	{
		...
		ClienteModel.updateUser(userData,function(error, data)
		{
	...
	app.delete("/users", function(req,res)
	{
		...
		var id = req.param('id');
		ClienteModel.deleteUser(id,function(error, data)
		{
